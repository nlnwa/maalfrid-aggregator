...
func (*CrawlSeedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6174c6c764907a0, []int{0}
}
...
func (*CrawlExecutionId) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6174c6c764907a0, []int{1}
}
...
func (*PageHarvest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6174c6c764907a0, []int{2}
}
...
func (*PageHarvest_Metrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6174c6c764907a0, []int{2, 0}
}
...
func (*PageHarvestSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_e6174c6c764907a0, []int{3}
}
...
func init() { proto.RegisterFile("frontier.proto", fileDescriptor_e6174c6c764907a0) }

var fileDescriptor_e6174c6c764907a0 = []byte{
