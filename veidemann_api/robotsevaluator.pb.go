...
func (*IsAllowedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_73debfed1e198641, []int{0}
}
...
func (*IsAllowedReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_73debfed1e198641, []int{1}
}
...
func init() { proto.RegisterFile("robotsevaluator.proto", fileDescriptor_73debfed1e198641) }

var fileDescriptor_73debfed1e198641 = []byte{
